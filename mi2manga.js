...
module.exports = class MangasWIKI {
  ...
  obtenerDatosManga(){
    ...
    return new Promise( async (resolve,reject) => {
      ...
      let datos = {
        tituloM:limpiarChr($('body > div.wrap > div > div.site-content > div > div.profile-manga > div > div > div > div.post-title > h1').text()),
        sinopsis:$('#nav-profile > div > div > p').text().trim(),
        demografia:"",
        url:this.url,
      ...
      this.id = $('body > div.wrap > div > div.site-content > div > div.profile-manga > div > div > div > div.tab-summary > div.summary_content_wrap > div > div.post-content > div.post-rating > input').attr('value');
  ...
  //https://es.mi2manga.com/manga/en-realidad-yo-era-la-verdadera/
  ...
  obtenerCapitulos(){
    ...
    return new Promise( async (resolve,reject) => {
      ...
      let config = {
        ...
        url: 'https://es.mi2manga.com/wp-admin/admin-ajax.php',
        headers: { 
          ...data.getHeaders()
        },
        data : data
  ...
  async descargarImagenes(){
    ...
    return new Promise( async (resolve) => {
      ...
      if((this.ini+1) == this.fin){
        ...
        let nombreCap = limpiarNombre($('#chapter-heading').text().trim());

        ul = $('div.reading-content > div.page-break');
  ...
  return new Promise( async resolve => {
    ...
    try {
      const respuesta = await axios({
        method: 'GET',
        url: $('body > div.wrap > div > div.site-content > div > div.profile-manga > div > div > div > div.tab-summary > div.summary_image > a > img').attr('src'),
        responseType: 'stream'
      });
